...
\begin{frame}\frametitle{SVM (binary): slack variables} %% LSP 103-104
\begin{itemize}
...
\column{.4\textwidth}\footnotesize {\bf Figure 7.3}
(\href{http://research.microsoft.com/en-us/um/people/cmbishop/prml}{Bishop
...
\begin{frame}\frametitle{SVM (binary): loss function} %% LSP 103-104
\small
\begin{itemize}
